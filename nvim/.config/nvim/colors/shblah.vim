...
highlight CursorLine   term=NONE cterm=NONE ctermfg=7    ctermbg=8
...
highlight Directory    term=NONE cterm=bold ctermfg=4    ctermbg=NONE
...
highlight Search       term=NONE cterm=bold ctermfg=7    ctermbg=8
highlight IncSearch    term=NONE cterm=bold ctermfg=7    ctermbg=8
highlight Special      term=NONE cterm=bold ctermfg=13    ctermbg=NONE
...
highlight SignColumn   term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
highlight StatusLine   term=NONE cterm=bold ctermfg=10    ctermbg=NONE
" highlight StatusLineNC term=NONE cterm=bold ctermfg=0    ctermbg=NONE
highlight String       term=NONE cterm=NONE ctermfg=10    ctermbg=NONE
highlight TabLineSel   term=NONE cterm=bold ctermfg=7    ctermbg=NONE
highlight Todo         term=NONE cterm=bold ctermfg=7    ctermbg=1
highlight Type         term=NONE cterm=bold ctermfg=9    ctermbg=NONE
...
highlight MatchParen   term=NONE cterm=bold ctermfg=7    ctermbg=0
