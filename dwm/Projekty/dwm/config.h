...
static const unsigned int barheight = 10;        /* height of the bar */
static const unsigned int ulheight = 1;        /* height of tag underline */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */

/* colors */
static const char col_jellybean0[]  = "#121212";
...
static const char *colors[][3]      = {
	...
	[SchemeSelTag] = { col_jellybean17,  col_jellybean1, col_jellybean1  },
...
static const char *rcmenucmd[] = { "/home/jj/Skrypty/rofimenu", NULL };
...
static Button buttons[] = {
	...
	{ ClkRootWin,           0,              Button3,        spawn,          {.v = rcmenucmd} },
};
